...
const Sidepanel = ({ show, onThemeChange }) => {
    ...
    const closeThemeOptions = (event) => {
        if (isThemeOptionsOpen && !event.target.closest('.theme-options') && !event.target.closest('.change-theme-trigger')) {
            setIsThemeOptionsOpen(false);
        }
    };
            ...
            >
                ...
                {isThemeOptionsOpen && (
                    <div className="theme-options absolute bg-white p-2 shadow-md">
                        ...
                        <div className="theme-option" onClick={() => handleThemeChange('#b5c99a')}>Mint</div>
                        <div className="theme-option" onClick={() => handleThemeChange('#9c6644')}>Brown</div>
