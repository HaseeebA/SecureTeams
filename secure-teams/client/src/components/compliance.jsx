		...
		<>
			<div className="compliance-document">
				...
				<p>
					...
					communication and collaboration among team members within
					organizations. This compliance document outlines the policies,
					procedures, and controls implemented to ensure compliance with
					relevant laws, regulations, and industry standards regarding data
				...
				<ul>
					...
					<ul>
						...
						<li>
							...
							data, the right to rectify inaccurate data, the right to erasure
							and the right to restrict processing.
						</li>
						<li>
							Lawful Basis for Processing: The company must have a lawful basis
							for processing personal data. This could include obtaining
							explicit consent from the data subject, processing necessary for
							the performance of a contract, compliance with legal obligations,
							protection of vital interests, performance of a task carried out
							in the public interest or in the exercise of official authority,
							and legitimate interests pursued by the data controller or a third
							party.
						</li>
						<li>
							Data Protection Principles: GDPR establishes several principles
							for the processing of personal data, including lawfulness,
						...
						<li>
							...
							relevant supervisory authorities of data breaches within 72 hours
							of becoming aware of the breach, unless the breach is unlikely to
				...
				<p>
					Secure Teams adheres to the following comprehensive set of policies
					and procedures to ensure the security and integrity of user data:
				</p>
				<ul>
					...
					<ul>
						...
						<li>
							It specifies the types of data collected, the purposes for which
							it is collected, and the lawful basis for processing.
						</li>
						<li>
							The policy details procedures for obtaining user consent, handling
							data subject requests, and ensuring compliance with data
					...
					<ul>
						...
						<li>
							Secure Teams employs industry-standard security practices to
					...
					<ul>
						<li>
							The User Access Control Policy governs the management of user
							access rights and privileges within the Secure Teams platform.
						</li>
						<li>
							It defines roles and permissions for different user categories
							based on job roles, responsibilities, and organizational
							requirements.
						</li>
						<li>
							Secure Teams follows the principle of least privilege, ensuring
							that users have access only to the resources and functionalities
					...
					<ul>
						...
						<li>
							It establishes a clear chain of command, roles, and
						...
						<li>
							...
							notification alerts to admin on multiple wrong password attempts
							and being logged out of the account.
						</li>
					</ul>
					<p>
				...
				<p>
					This compliance document serves as a comprehensive guide to the
					security measures and compliance practices implemented by Secure Teams
					to safeguard user data and ensure regulatory compliance.
				</p>
			</div>
